...
When `reporting a bug <https://github.com/oemof/feedinlib/issues>`_ please include:
...
feedinlib could always use more documentation, whether as part of the
official feedinlib docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `feedinlib <https://github.com/oemof/feedinlib>`_
